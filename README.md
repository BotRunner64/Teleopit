...
- Switched training datasets to recursive minimal HDF5 shards with no train/val split or manifest; training derives FK/velocities while loading the motion cache.
