...
- 训练 task：`Tracking-Flat-G1-VelCmdHistory`、`Tracking-Flat-G1-VelCmdHistoryAdaptive`、`Tracking-Flat-G1-VelCmdHistoryRegular`、`Tracking-Flat-G1-MotionTrackingDeploy`
