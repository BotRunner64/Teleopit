...
from train_mimic.tasks.tracking.config.env import (
    ...
    make_velcmd_history_deploy_tracking_env_cfg,
...
from train_mimic.tasks.tracking.config.rl import (
    ...
    make_velcmd_history_deploy_tracking_ppo_runner_cfg,
...
register_mjlab_task(
    task_id=VELCMD_HISTORY_DEPLOY_TASK,
    env_cfg=make_velcmd_history_deploy_tracking_env_cfg(),
    play_env_cfg=make_velcmd_history_deploy_tracking_env_cfg(play=True),
    rl_cfg=make_velcmd_history_deploy_tracking_ppo_runner_cfg(
        experiment_name=VELCMD_HISTORY_DEPLOY_EXPERIMENT_NAME
    ),
    runner_cls=MotionTrackingOnPolicyRunner,
)
