...
Copied from mjlab 1.2.0 ``mjlab.tasks.tracking.config.g1.env_cfgs`` for local
customisation.  Imports the base ``make_tracking_env_cfg`` from the local copy
in ``tracking_env_cfg.py``.
"""
...
def make_g1_flat_tracking_env_cfg(
    ...
    # ------------------------------------------------------------------
    cfg.commands["motion"].motion_file = DEFAULT_TRAIN_MOTION_FILE
