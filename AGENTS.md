...
Quick reference:
 ...
 Train: `python train_mimic/scripts/train.py --task Isaac-G1-Mimic-v0 --num_envs 4096 --max_iterations 30000 --headless`
 Export: `python train_mimic/scripts/save_onnx.py --checkpoint <path> --output policy.onnx`
 USD convert: `OMNI_KIT_ACCEPT_EULA=YES python train_mimic/scripts/convert_urdf_isaaclab.py --headless`
