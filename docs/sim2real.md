...
### PD 增益（来自 mjlab g1_constants.py stiffness/damping）

```
kp: [40.2, 99.1, 40.2, 99.1, 28.5, 28.5,
...
与仿真训练 PD 增益一致，sim2real 不再使用旧 TWIST2 deploy_real 值。
